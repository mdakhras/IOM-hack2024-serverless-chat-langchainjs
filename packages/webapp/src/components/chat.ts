...
export const defaultOptions: ChatComponentOptions = {
  ...
  promptSuggestions: [
    'What are the visa requirements for [Potential Destination Country]?',
    'What are the job opportunities in [Potential Destination Country]?',
    'What is the cost of living in [Potential Destination Country]?',
    'How can I find housing in [Potential Destination Country]?',
    'What are the cultural differences in [Potential Destination Country] and how can I adapt?',
    'I am thinking about moving to another country. Any ideas?',
  ],
  messages: [],
  strings: {
    promptSuggestionsTitle: 'Hi, I am Rafiki. Whether you are exploring new horizons or seeking detailed information on migration processes, I am here to help you every step of the way. You can either ask any questions you have or use one of the suggested questions below!',
